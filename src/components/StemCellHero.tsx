...
export default function StemCellHero() {
  ...
  const bgImage = getImageByKey(cmsData, 'stemcell_hero_bg')
  const title = getContentByKey(cmsData, 'stemcell_hero_title', locale) || t('defaultTitle')
  const subtitle = getContentByKey(cmsData, 'stemcell_hero_subtitle', locale) || t('defaultSubtitle')

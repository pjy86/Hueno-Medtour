      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          <form
            ...
            className="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.12)] p-8"
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-[#1861D7] hover:bg-[#1250a0] disabled:bg-gray-400 text-white py-4 rounded-lg font-semibold text-lg transition-colors flex items-center justify-center gap-2 cursor-pointer"
            >
              {loading ? (
